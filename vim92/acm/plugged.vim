...
let g:ale_cpp_cc_options='-std=c++17 -O2 -Wall -Wno-sign-compare -Wno-unused-variable' "gcc编译检查配置

let g:ale_linters = {'python': ['pylint']}
let g:ale_python_pylint_options = '--disable=all --enable=F,E' "pylint只显示错误警告
let g:ale_java_javac_options = '-J-Dfile.encoding=UTF-8 -encoding UTF-8 -J-Duser.language=en -J-Duser.country=US' "javac配置
...
"airline配置
let g:airline_powerline_fonts = 1	"配合Nerd Font等字体
